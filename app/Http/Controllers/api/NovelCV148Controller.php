...
class NovelCV148Controller extends Controller
{
    public $siteUrl = "https://www.cv148.com";
    public $source = 'cv148'; 
    public function search(Request $request)
    {
        ...
        $books = app()->make('CommonService')->curl($this->siteUrl . '/modules/article/search.php', ['searchkey' => $keyword], 1,0,1);
        ...
        foreach ($list as $key => $ele) {
            ...
            if (!$nd) {
                ...
                NovelDetail::create([
                    ...
                    'catalog_id' => $key,
                    'title' => $ele->plaintext,
                    'source_href' => $catalog_url .$ele->href,
                    'source' => $this->source,
                ]);
            }
            else{
