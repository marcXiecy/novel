...
class NovelQbiqugeController extends Controller
{
    public $siteUrl = "https://www.qbiqu.com";
    public $source = 'qbiquge'; 
    public function search(Request $request)
    {
        $keyword = $request->input('keyword');
        $keyword = mb_convert_encoding($keyword, 'GBK', 'UTF-8');

        $books = app()->make('CommonService')->curl($this->siteUrl . '/modules/article/search.php', ['searchkey' => $keyword], 0,0,1);
