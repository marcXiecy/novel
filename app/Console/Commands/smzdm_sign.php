...
class smzdm_sign extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $url = 'https://zhiyou.smzdm.com/user/checkin/jsonp_checkin?callback=' . time() * 1000 .'&_=' . time() * 1000;
            $res = $httpClient->get(
                $url,
                [
                    'headers' => [
